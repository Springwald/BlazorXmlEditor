...
namespace de.springwald.xml.editor
{
    ...
    public abstract class XMLElement : IDisposable
    {
        ...
        /// </summary>
        public virtual async Task Paint(int marginLeft, XMLPaintArten paintArt, PaintEventArgs e)
        {
            ...
            await NodeZeichnenStart(marginLeft, paintArt, e);
            await UnternodesZeichnen(marginLeft, paintArt, e);
            await NodeZeichnenAbschluss(marginLeft, paintArt, e);
        ...
        /// </summary>
        protected virtual async Task NodeZeichnenStart(int marginLeft, XMLPaintArten paintArt,  PaintEventArgs e)
        {
        ...
        protected virtual async Task UnternodesZeichnen(int marginLeft, XMLPaintArten paintArt,  PaintEventArgs e)
        {
...
#warning Hier noch vorausschauend berechnen, d.h. die wahrscheinliche Länge des ChildElementes beim Rechnen bereits anhängen
                            ...
                            await childElement.Paint(marginLeft, paintArt, e);
                            break;
        ...
        /// </summary>
        protected virtual async Task NodeZeichnenAbschluss(int marginLeft, XMLPaintArten paintArt,  PaintEventArgs e)
        {
