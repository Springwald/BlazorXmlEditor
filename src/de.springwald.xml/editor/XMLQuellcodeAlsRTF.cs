...
//{
//    /// <summary>
//    /// Liefert zu einem angegebenen XML die Quellcodeansicht als RTF und die passende
//    /// Fehlerdokumentation (auch als RTF)
//    /// </summary>
//    /// <remarks>
...
//        /// <summary>
//        /// Zeigt den Quellcode und daneben die Fehler in einem aufpoppenden Form an
//        /// </summary>
//        public void QuellCodeUndFehlerInNeuemFormZeigen()
//        {
//            using (frmDokFehlerZeigen form = new frmDokFehlerZeigen())
//            {
//                form.Anzeigen(this.QuellCodeAlsRTF, this.FehlerProtokollAlsText);
//                form.ShowDialog();
//            }
//        }
