...
//    {
//        private List<TextSplitPart> _textTeile;    // Die entstandenen Textteile
...
//        /// </summary>
//        private List<TextSplitPart> TextUmbrechenUndAufTeileVerteilen(string text, int laengeAktZeile, int maxLaengeProZeile)
//        {
...
//        /// zu lange Texte sein (Zeilenumbruch) 
//        /// </summary>
//        private List<TextSplitPart> TextAufTextTeileVerteilen(string text, int laengeAktZeile, int maxLaengeProZeile)
//        {

//            List<TextSplitPart> teile = new List<TextSplitPart>();
